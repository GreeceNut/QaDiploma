...
2. Ввести в поле "Номер карты" 4444 4444 4444 4441, в поле "Месяц" — 13.
   _Ожидаемый результат: Поле не приняло значение. Появляется сообщение под полем "Месяц" "Неверно указан срок действия карты""_
...
2. Ввести в поле "Номер карты" 4444 4444 4444 4441, в поле "Год" — +6 от текущего года.
   _Ожидаемый результат: Поле не приняло значение. Появляется сообщение под полем "Год" "Неверно указан срок действия карты"_
